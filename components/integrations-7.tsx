...
export default function IntegrationsSection(): React.ReactElement {
    return (
        <section>
            <div className="bg-muted dark:bg-background py-12 md:py-16">
                <div className="mx-auto max-w-5xl px-6">
                    ...
                    <div className="mx-auto mt-0 max-w-lg space-y-6 text-center">
                        <h2 className="text-balance text-3xl font-semibold md:text-4xl">Power Your Business with Solnix Media</h2>
                        <p className="text-muted-foreground">Leverage our comprehensive suite of digital tools and platforms to elevate your business presence and drive growth.</p>
