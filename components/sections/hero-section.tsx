                    ...
                    <div className="mx-auto max-w-7xl px-6 sm:px-8">
                        ...
                        <div className="text-center sm:mx-auto lg:mr-auto lg:mt-10">
                            ...
                            <TextEffect
                                ...
                                We help SMBs increase revenue by 40% on average through stunning websites, AI automation, and proven digital marketing strategies. Join 50+ successful businesses already growing with Solnix Media.
                            </TextEffect>
                            ...
                            <AnimatedGroup className="mt-14 flex flex-col items-center justify-center gap-6 md:mt-16 md:flex-row md:gap-8">
                                ...
                                <Button
                                    ...
                                    <Link href="#services">
                                        <span className="text-nowrap">View Success Stories</span>
                                    </Link>
                                </Button>
                            </AnimatedGroup>
                        </div>
