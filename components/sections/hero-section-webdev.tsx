...
export default function HeroSectionWebDev() {
    return (
        <ErrorBoundary>
                    ...
                    <div className="mx-auto max-w-7xl px-6 sm:px-8">
                        ...
                        <div className="text-center sm:mx-auto lg:mr-auto lg:mt-10">
                            ...
                            <AnimatedGroup>
                                <Link
                                    ...
                                    <AnimatedGradientText className="text-sm font-semibold tracking-tight">
                                        💻 30+ High-Converting Websites Delivered
                            ...
                            <TextEffect
                                ...
                                Lightning-fast, mobile-optimized websites that generate 3x more leads and 25% higher conversion rates. From design to deployment in just 48 hours. No more losing customers to slow, outdated websites.
                            </TextEffect>
                            ...
                            <AnimatedGroup className="mt-14 flex flex-col items-center justify-center gap-6 md:mt-16 md:flex-row md:gap-8">
                                ...
                                <div
                                    ...
                                    <Button
                                        ...
                                        <Link href="#contact">
                                            <span className="text-nowrap">Get My Website Now</span>
                                        </Link>
                                    </Button>
                                </div>
                                ...
                                <Button
                                    ...
                                    <Link href="#testimonials">
                                        <span className="text-nowrap">See Success Stories</span>
                                    </Link>
                                </Button>
                            </AnimatedGroup>
                        </div>
