                    ...
                    <div className="mx-auto max-w-7xl px-6 sm:px-8">
                        ...
                        <div className="text-center sm:mx-auto lg:mr-auto lg:mt-10">
                            ...
                            <TextEffect
                                ...
                                Stop throwing money at ads that don&apos;t work. Our ROI-focused campaigns generate $5 for every $1 spent. Rank #1 on Google, dominate social media, and get 150% more traffic in just 90 days.
                            </TextEffect>
                            ...
                            <AnimatedGroup className="mt-14 flex flex-col items-center justify-center gap-6 md:mt-16 md:flex-row md:gap-8">
                                ...
                                <div
                                    ...
                                    <Button
                                        ...
                                        <Link href="#contact">
                                            <span className="text-nowrap">Multiply My Revenue</span>
                                        </Link>
                                    </Button>
                                </div>
